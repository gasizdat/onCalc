...
(function (Tests) {
    var AnySignUnitTests = (function (_super) {
        ...
        AnySignUnitTests.prototype.divOperator = function () {
            var x = this.longInt("4096");
            var y = this.longInt("512");
            x.div(y);
            Tests.EXPECT_EQ(new onCalc.LongInt("8"), x);
            ...
            x.div(y);
            Tests.EXPECT_EQ(new onCalc.LongInt("23948328589768940387378393420312098290200909000000000000000000000345345344354353458"), x);
        };
    ...
    var signRelatedUnitTests = (function (_super) {
        ...
        signRelatedUnitTests.prototype.bisectionOperator = function () {
            ...
            console.log("2045 bisections at " + _super.prototype.stopWatchStop.call(this) + " ms");
            Tests.EXPECT_EQ(2045, i);
        };
        signRelatedUnitTests.prototype.gcdOperator = function () {
            var x = this.longInt(30);
            var y = this.longInt(15);
            var gcd = onCalc.LongInt.gcd(x, y);
            Tests.EXPECT_EQ(this.longInt(15), gcd);
            ...
            gcd = onCalc.LongInt.gcd(x, y);
            Tests.EXPECT_EQ(this.longInt(6), gcd);
        };
